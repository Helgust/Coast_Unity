...
public class DB : MonoBehaviour
{
    ...
    //Ðàñ÷åò òðåáóåìîãî êîëè÷åñòâà ðàáî÷èõ ìåñò íà êîíêðåòíîì ïðåäïðèÿòèè
    ...
    //Ðàñ÷åò òðåáóåìîãî êîëè÷åñòâà âîñòðåáîâàííûõ ðàáî÷èõ ìåñò íà êîíêðåòíîì ïðåäïðèÿòèè
    ...
    {
        float Res;
        //ProdRez - Ïðîèçâîäñòâåííûé ðåçåðâ
        //VolRes - Îáúåì ñûðüÿ
        if (ProdRez > VolRes)
        {
            Res = VolRes;
    ...
    //Ðàñ÷åò îáúåìà ïðîèçâîäñòâà áåç ó÷åòà êîëè÷åñòâà äîñòóïíîãî ñûðüÿ
    ...
    //Ðàñ÷åò ñóììàðíîãî äîõîäà âñå îòðàñëåé (áåç î÷èñòíûõ ñîîðóæåíèé)
    ...
    //Ïîïðàâêà íà ÷óñòâèòåëüíîñòü òåõíîëîãèè ê ïåðåðàáîòêå (Áèîëîãè÷åñêàÿ î÷èñòêà)
